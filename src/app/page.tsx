  ...
  return (
    <div className="font-quicksand">
      ...
      <section className="relative min-h-[92vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/find-shelter" className="bg-amor text-alma px-8 py-4 rounded-full font-bold text-base hover:bg-teto transition-colors">
              Find Shelter
            </Link>
            <Link href="/our-why" className="border-2 border-alma text-alma px-8 py-4 rounded-full font-bold text-base hover:bg-alma hover:text-cruz transition-colors">
              Our Why
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Link key={p.name} href={p.href} className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow">
                <div className="relative h-52 overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-cruz/20 group-hover:bg-cruz/10 transition-colors" />
                </div>
                <div className="p-8">
                  ...
                  <span className="inline-block mt-6 text-amor text-sm font-semibold group-hover:underline">Learn more →</span>
                </div>
              </Link>
            ))}
          </div>
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-teto/80" />
      ...
      <section className="bg-alma py-24 px-6">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="relative rounded-2xl overflow-hidden min-h-[280px] flex items-end">
            <img src="https://images.unsplash.com/photo-1544027993-37dbfe43562a?w=800&q=80" alt="Family seeking support" className="absolute inset-0 w-full h-full object-cover" />
            ...
            <div className="relative z-10 p-10 text-alma">
              ...
              <p className="text-alma/80 mb-6 text-sm leading-relaxed">You don't have to carry it alone. Reach out and let us walk with you.</p>
              <Link href="/find-shelter" className="inline-block bg-alma text-amor px-6 py-3 rounded-full font-bold text-sm hover:bg-pele transition-colors">Find Shelter</Link>
            </div>
          </div>
          <div className="relative rounded-2xl overflow-hidden min-h-[280px] flex items-end">
            <img src="https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=800&q=80" alt="Giving and generosity" className="absolute inset-0 w-full h-full object-cover" />
            <div className="absolute inset-0 bg-cruz/80" />
            <div className="relative z-10 p-10 text-alma">
              <h3 className="text-2xl font-bold mb-3">Want to help?</h3>
              <p className="text-alma/80 mb-6 text-sm leading-relaxed">Your generosity restores families. Every gift builds a stronger home.</p>
              <Link href="/give" className="inline-block bg-pele text-cruz px-6 py-3 rounded-full font-bold text-sm hover:bg-alma transition-colors">Give Now</Link>
            </div>
          </div>
        </div>
      </section>
