  ...
  return (
    <div className="font-quicksand">
      ...
      <section className="relative py-28 px-6 text-center overflow-hidden min-h-[60vh] flex items-center justify-center">
        <img src="https://images.unsplash.com/photo-1511895426328-dc8714191011?w=1800&q=80" alt="Family together" className="absolute inset-0 w-full h-full object-cover" />
