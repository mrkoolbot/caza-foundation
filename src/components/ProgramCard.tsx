  ...
  return (
    <article className={cn(
      ...
      <Link href={href} className="flex flex-col h-full">
        {/* Image — grayscale → color on hover like TKG */}
        <div className="relative w-full h-44 sm:h-56 md:h-64 overflow-hidden bg-neutral-100">
          <img
            src={image}
            alt={title}
        ...
        <div className="p-5 sm:p-6 md:p-8 flex flex-col flex-grow">
          <div className="flex justify-between items-start mb-3 sm:mb-4">
            <span className="text-[10px] sm:text-xs font-bold tracking-[0.15em] text-neutral-400 uppercase">{type}</span>
